...
public class ApiConfig {
	...
	public static final String UPLOAD_DATA_DIRECTORY = "/home/hoangquan/web-sale-clip-data";
	public static final String USER_AVATAR = "/user/avatar";
	public static final String USER_VIDEO = "/user/clips";
	...
	public static final String MY_CLIPS = "/my-clips";
	public static final String DISPLAY_USER_AVATAR = "/avatar";
